...
void vec_pop_back(vector_t *v) { v->size--; }

VEC_DATA_TYPE vec_front(vector_t *v) { return v->data[0]; }

VEC_DATA_TYPE *vec_front_ref(vector_t *v) { return &v->data[0]; }

VEC_DATA_TYPE vec_back(vector_t *v) { return v->data[v->size - 1]; }

VEC_DATA_TYPE *vec_back_ref(vector_t *v) { return &v->data[v->size - 1]; }

VEC_DATA_TYPE vec_at(vector_t *v, size_t index) { return v->data[index]; }

VEC_DATA_TYPE *vec_at_ref(vector_t *v, size_t index) { return &v->data[index]; }
